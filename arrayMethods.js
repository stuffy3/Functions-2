...
// CODE HERE
const myStrongest  = monstersInYourPocket.filter(function(monstersInYourPocket){
...
// CODE HERE
const ordersTotal = orders.filter(function(prices) {  
    return prices.price + (prices.price * prices.tax)
...
const reducesPurchases = purchases.filter(function(elem) {
  return elem.owner === 'Bob' 
}).reduce(function(acc, elem) {
  return acc + elem.price
}, 0)
console.log(reducesPurchases);